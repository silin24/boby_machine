...
<script>
import request from '@/components/custom-upload/request';
// import MyProgress from '@/components/custom-upload/progress';
import UploadList from '@/components/custom-upload/customUpload-list';
import { noop } from '@/utils/utils';
import UploadDragger from '@/components/custom-upload/upload-dragger';
export default {
  name: 'GoUpload',
